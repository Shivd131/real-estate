    ...
    useEffect(() => {
        const fetchListing = async () => {
            ...
            try {
                ...
                console.log('yosdf')
                const fetchedData = data as FormData;

                setFormData(fetchedData);

                console.log(formData.name, "asdf")
                console.log(data)
                console.log('yo')
            } catch (error) {
        ...
        fetchListing(); // Call fetchListing inside useEffect
        ...
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <Formik
                ...
                onSubmit={(values, { setSubmitting }) => {
                    ...
                    setLoading(true);
                    axios.post(`/api/listing/update/${params.listingId}`, updatedValues)
                        .then(response => {
